public class RedactionProfessionnel extends Activite implements IErreurs{
    protected int index = 5;
    public RedactionProfessionnel(String description, String categorie, long heures, String date){
    ...
    public RedactionProfessionnel(long heures){
        super(heures);
    }
