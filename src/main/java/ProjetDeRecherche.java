public class ProjetDeRecherche extends Activite implements IErreurs{
    protected int index = 2;

    public ProjetDeRecherche(String description, String categorie, long heures, String date){
    ...
    public ProjetDeRecherche(long heures){
        super(heures);
    }
