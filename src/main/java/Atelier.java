public class Atelier extends Activite implements IErreurs {
    protected int index = 6;
    public Atelier(String description, String categorie, long heures, String date){
    ...
    protected boolean validerFormatHeure() {
        ...
        compteurHeuresRequisesArchitecteFormation += this.heures; //pour avoir les 17h requises
        return true;
    }
