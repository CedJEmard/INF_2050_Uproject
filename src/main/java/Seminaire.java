public class Seminaire extends Activite implements IErreurs{
    protected int index = 9;

    public Seminaire(String description, String categorie, long heures, String date){
