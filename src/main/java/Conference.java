public class Conference extends Activite implements IErreurs{
    protected int index = 3;

    public Conference(String description, String categorie, long heures, String date){
