public class Colloque extends Activite implements IErreurs {
    protected int index = 7;

    public Colloque(String description, String categorie, long heures, String date){
