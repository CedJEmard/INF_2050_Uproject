public class Presentation extends Activite implements IErreurs{
    protected int index = 4;

    public Presentation(String description, String categorie, long heures, String date){
    ...
    public Presentation(long heures){
        super(heures);
    }
