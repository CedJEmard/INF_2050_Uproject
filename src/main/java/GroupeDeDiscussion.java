public class GroupeDeDiscussion extends Activite implements IErreurs{
    protected int index = 1;

    public GroupeDeDiscussion(String description, String categorie, long heures, String date){
    ...
    public GroupeDeDiscussion(long heures){
        super(heures);
    }
